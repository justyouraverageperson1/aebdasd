...
idleOffsets = {'181', '29'}        -- I recommend you have your idle offset at 0
leftOffsets = {'171', '79'}
downOffsets = {'169', '6'}
upOffsets = {'205', '61'}
rightOffsets = {'188', '8'}
...
idle_xml_name = 'BALLER_IDLE0'
left_xml_name = 'BALLER_LEFT0'
down_xml_name = 'BALLER_DOWN0'
up_xml_name = 'BALLER_UP0'
right_xml_name = 'BALLER_RIGHT0'
...
name_of_character_xml = 'BALLERmad'
name_of_character = 'ballermad2'
charNote = 'baller'
