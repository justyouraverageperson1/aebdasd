...
idleoffsets = {'-1', '7'} -- I recommend you have your idle offset at 0
leftoffsets = {'-3', '24'}
downoffsets = {'1', '-20'}
upoffsets = {'-34', '48'}
rightoffsets = {'-53', '12'}
...
right_xml_name = 'Dad Sing Note LEFT'
down_xml_name = 'Dad Sing Note DOWN'
up_xml_name = 'Dad Sing NOTE UP'
left_xml_name = 'Dad Sing NOTE RIGHT'
...
name_of_character_xml = 'dad-6-6alt'
name_of_character = 'dad-air-dark'
name_of_notetype = 'gfNote'
name_of_notetype2 = 'gfDadNote'
name_of_notetype3 = 'bfGfDadNote'
name_of_notetype4 = 'gfBfNote'
