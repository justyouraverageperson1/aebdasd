...
idleoffsets = {'-198', '-220'} -- I recommend you have your idle offset at 0
leftoffsets = {'-143', '-227'}
downoffsets = {'-145', '-295'}
upoffsets = {'-232', '-183'}
rightoffsets = {'-279', '-218'}

-- change all of these to the name of the animation in your character's xml file
idle_xml_name = 'Pico Idle Dance'
right_xml_name = 'Pico Note Right'
down_xml_name = 'Pico Down Note'
up_xml_name = 'pico Up note'
left_xml_name = 'Pico NOTE LEFT'
...
name_of_character_xml = 'pico-uncorrupt2'
name_of_character = 'gf-save-4'
name_of_notetype = 'spookyNote'
name_of_notetype2 = 'momSpookyNote'
name_of_notetype3 = 'momSpookyPicoNote'
name_of_notetype4 = 'picoSpookyNote'
