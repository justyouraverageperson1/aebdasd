...
right_xml_name = 'Mom Pose Left'
down_xml_name = 'MOM DOWN POSE'
up_xml_name = 'Mom Up Pose'
left_xml_name = 'Mom Left Pose'
...
name_of_character_xml = 'mom-motivated'
name_of_character = 'mom-motivated'
name_of_notetype = 'dadNote'
name_of_notetype2 = 'gfDadNote'
name_of_notetype3 = 'bfGfDadNote'
name_of_notetype4 = 'bfDadNote'
