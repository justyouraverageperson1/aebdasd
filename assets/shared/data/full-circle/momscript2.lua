...
idleoffsets = {'60', '-210'} -- I recommend you have your idle offset at 0
leftoffsets = {'56', '-208'}
downoffsets = {'54', '-214'}
upoffsets = {'66', '-210'}
rightoffsets = {'53', '-210'}
...
idle_xml_name = 'BGF IdleCorrupt'
right_xml_name = 'BGF Note RIGHTCorrupt'
down_xml_name = 'BGF Note DOWNCorrupt'
up_xml_name = 'BGF Note UPCorrupt'
left_xml_name = 'BGF Note RIGHTCorrupt'
...
name_of_character_xml = 'gf-save-2'
name_of_character = 'dad-uncorrupt-2'
name_of_notetype = 'momNote'
